...
import 'package:e_grocery/models/cartModel.dart';
import 'package:e_grocery/models/productModel.dart';
import 'package:e_grocery/widgets/eco_button.dart';
import 'package:e_grocery/widgets/header.dart';
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Center(
                            child: Text("${allProducts.first.price} FCFA",
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                        "NOTE :  Discount of ${allProducts.first.discountPrice} FCFA will be applied when you order more then three items of this product"),
                  ),
                  Container(
                    child: Row(
                      children: [
